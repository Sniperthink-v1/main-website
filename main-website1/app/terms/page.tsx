      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="mb-6">
            ...
            and sole agreement between you and the Company regarding your access
            to and use of this Site. For any questions about your use of the
            Site, please contact us at: info@sniperthink.com.
          </p>

          <p className="mb-4">
            You are permitted to use the Site if you meet the following
            criteria:
          </p>
          <ul className="list-disc pl-6 mb-6">
            <li className="mb-2">You are 18 years of age or older.</li>
            <li className="mb-2">
              You agree to comply with these Terms of Use and our Privacy
              Policy.
            </li>
          </ul>
          ...
          <p className="mb-6">
            ...
            services provided on the Site for your internal use.
          </p>
          ...
          <ol className="list-decimal pl-6 mb-6 space-y-2">
            ...
            <li>
              Use any content on the Site in a way that violates any applicable
              law.
            </li>
            <li>
              Use the Site in any manner that could adversely affect our
              systems.
            </li>
            <li>
          ...
          <p className="mb-6">
            All content, features, and functionality of the Site are the
            intellectual property of the Company. You agree not to modify,
            resell, reuse, license, distribute, or use our intellectual property
          ...
          <p className="mb-6">
            You acknowledge that you have read and fully understood the terms of
            our Privacy Policy. Your use of the Site is subject to our Privacy
          ...
          <div className="bg-red-900/20 border-l-4 border-red-400 p-4 mb-8">
            <p className="text-red-200">
              ...
              RELATING TO YOUR ACCESS TO OR USE OF THE SITE OR ITS CONTENT. OUR
              TOTAL CUMULATIVE LIABILITY SHALL NOT EXCEED INR 1000.
            </p>
          </div>
          ...
          <p className="mb-6">
            ...
            the laws of India. The courts located in Noida, UP shall have
