...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative px-4 sm:px-6 lg:px-8 min-h-screen overflow-hidden flex items-center py-8 sm:py-12 lg:py-4"
    >
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-8 items-center w-full">
          ...
          <div className="text-center lg:text-left order-1 lg:order-1">
            ...
            >
              ...
              <span className="text-[#91C499] font-medium text-sm sm:text-base">
                {"Your 24/7 AI Agent is here"}
              </span>
            </motion.div>
                        ...
                        <div className="h-full flex flex-col">
                          ...
                          <div className="flex items-center space-x-2 xs:space-x-3 px-2 xs:px-3 sm:px-4 py-2 xs:py-2.5 sm:py-3 border-b border-gray-700 bg-gray-850 flex-shrink-0">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold text-white text-xs xs:text-sm sm:text-base">
                                SniperThink AI
                              </h3>
                              <p className="text-[9px] xs:text-[10px] sm:text-xs text-green-400">
                            ...
                            <div className="flex space-x-2">
                              ...
                              <svg
                                className="w-3 xs:w-4 sm:w-5 h-3 xs:h-4 sm:h-5 text-gray-400"
                                fill="none"
                                viewBox="0 0 24 24"
                                stroke="currentColor"
                              >
                          ...
                          <div className="overflow-y-auto px-2 xs:px-3 sm:px-4 py-2 xs:py-3 space-y-2 xs:space-y-2.5 sm:space-y-3 max-h-[150px] xs:max-h-[170px] sm:max-h-[240px] lg:max-h-[200px] xl:max-h-[240px]">
                            ...
                            <div className="flex justify-start">
                              <div className="bg-gray-700/80 rounded-xl xs:rounded-2xl rounded-tl-sm px-2.5 xs:px-3 sm:px-4 py-1.5 xs:py-2 max-w-[75%]">
                                ...
                                <p className="text-[8px] xs:text-[9px] sm:text-xs text-gray-400 mt-1">
                                  9:41 AM
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex justify-end">
                              <div className="bg-gradient-to-r from-[#1A6262] to-[#91C499] rounded-xl xs:rounded-2xl rounded-tr-sm px-2.5 xs:px-3 sm:px-4 py-1.5 xs:py-2 max-w-[75%]">
                                <p className="text-[10px] xs:text-xs sm:text-sm text-white">
                                  I need help understanding your pricing plans
                                </p>
                                <p className="text-[8px] xs:text-[9px] sm:text-xs text-white/70 mt-1">
                                  9:42 AM
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex justify-start">
                              <div className="bg-gray-700/80 rounded-xl xs:rounded-2xl rounded-tl-sm px-2.5 xs:px-3 sm:px-4 py-1.5 xs:py-2 max-w-[75%]">
                                <p className="text-[10px] xs:text-xs sm:text-sm text-gray-100">
                                  I'd be happy to explain our pricing! We offer
                            ...
                            <div className="flex justify-start">
                              <div className="bg-gray-700/80 rounded-xl xs:rounded-2xl rounded-tl-sm px-2.5 xs:px-3 sm:px-4 py-2 xs:py-2.5">
                                <div className="flex space-x-1">
                                  <div
                                    className="w-1.5 xs:w-2 h-1.5 xs:h-2 bg-gray-400 rounded-full animate-bounce"
                          ...
                          <div className="border-t border-gray-700/50 px-2 xs:px-3 sm:px-4 py-1 xs:py-1.5 bg-gray-850 flex-shrink-0">
                            <div className="flex items-center space-x-1.5 xs:space-x-2">
                              ...
                              <div className="flex-1 bg-gray-700/50 rounded-full px-2.5 xs:px-3 sm:px-4 py-1 xs:py-1.5 sm:py-2 flex items-center">
                                <p className="text-[10px] xs:text-xs sm:text-sm text-gray-400 flex-1">
                                  Type a message...
                                </p>
                            ...
                            <div className="px-1 pt-0.5 pb-0 space-y-0.5">
                              ...
                              <div className="flex gap-0.5">
                                {[
                                  ...
                                  <div
                                    key={key}
                                    className="bg-gray-700 hover:bg-gray-600 transition-colors shadow-sm rounded-md flex-1 py-1.5 text-center cursor-pointer min-h-[28px] flex items-center justify-center"
                                  >
                                ...
                                <div className="flex flex-1 gap-0.5">
                                  {["Z", "X", "C", "V", "B", "N", "M"].map(
                                    (key) => (
                                      <div
                                        key={key}
                                        className="bg-gray-700 hover:bg-gray-600 transition-colors shadow-sm rounded-md flex-1 py-2 text-center cursor-pointer min-h-[30px] flex items-center justify-center"
                                      >
                                        <span className="text-[10px] text-gray-200 font-normal">
                                          {key}
                                        </span>
              ...
              <div className="bg-white/5 rounded-xl sm:rounded-2xl p-1 sm:p-1.5 md:p-2 shadow-2xl border border-white/10 backdrop-blur-sm">
                <div className="flex space-x-1 sm:space-x-2">
                  <Button
                    ...
                    className={`px-2.5 xs:px-3 sm:px-6 py-1.5 xs:py-2 sm:py-3 rounded-lg xs:rounded-xl transition-all duration-300 text-xs xs:text-sm sm:text-base ${
                      activeAgent === "chat"
