        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
            ...
            <div className="md:col-span-1 flex flex-col justify-center p-6">
              ...
              >
                Discover how SniperThink works{" "}
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Built to handle 50 or 5,000 chats — without breaking a
                    sweat.
                  </p>
                </div>
                <div className="flip-card-back">
                  <p className="text-white text-center font-medium">
                    Designed to perform at any scale, with zero drop in
                    precision.
                  </p>
                </div>
              </div>
            ...
            <div className="flip-card transition-all duration-300 ease-in-out">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  <p className="text-white text-center font-medium">
                    Every reply feels thoughtful, not templated — just like a
                    great rep would.
                  </p>
                </div>
              </div>
            ...
            <div className="flip-card transition-all duration-300 ease-in-out">
              <div className="flip-card-inner">
                <div className="flip-card-front">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Understand trends and act before they slip through the
                    cracks.
                  </p>
                </div>
                <div className="flip-card-back">
                  <p className="text-white text-center font-medium">
                    Spots what your CRM misses — timing, tone, and opportunity
                    signals.
                  </p>
                </div>
              </div>
            ...
            <div className="flip-card transition-all duration-300 ease-in-out">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  <p className="text-white text-center font-medium">
                    From signup to live in hours — built for busy teams, not
                    devs
                  </p>
                </div>
              </div>
            ...
            <div className="flip-card highlighted transition-all duration-300 ease-in-out">
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  <p className="text-white text-center font-medium">
                    Brings signal to the surface so your team never misses a
                    beat.
                  </p>
                </div>
              </div>
