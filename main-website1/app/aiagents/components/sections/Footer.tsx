...
import LegalDialog from "@aiagents/app/components/ui/LegalDialog";
import TermsOfUse from "@aiagents/app/components/ui/TermsOfUse";
import PrivacyPolicy from "@aiagents/app/components/ui/PrivacyPolicy";
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 md:gap-4">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 order-1 md:order-2">
            ...
            <div className="flex items-center gap-5">
              ...
              >
                <img
                  src="/aiagents/images/facebook.svg"
                  alt="Facebook"
              ...
              >
                <img
                  src="/aiagents/images/linkedin.svg"
                  alt="LinkedIn"
                  className="w-5 h-5 opacity-70 group-hover:opacity-100 transition-opacity duration-300"
                />
              </a>
