...
<<<<<<< HEAD
    ...
    gradient:
      "from-[rgba(187,222,193,1)] via-[rgba(108,145,111,1)] to-[rgba(46,73,49,1)]",
  ...
  },
  {
    ...
    gradient:
      "from-[rgba(250,216,145,0.6)] via-[rgba(210,159,52,0.6)] to-[rgba(154,115,31,0.6)]",
...
const FEATURES_DATA: Record<
  "product1" | "product2",
  Array<{ title: string; content: string }>
> = {
  product1: [
    {
      title: "Live KPI Intelligence",
      content:
        "Track critical metrics in real-time—from AOV to churn—without hunting across platforms or building complex dashboards.",
    },
    {
      title: "Predictive Growth Signals",
      content:
        "Identify trends and opportunities before they become obvious, giving you the competitive edge in your market.",
    },
    {
      title: "Smart Alert System",
      content:
        "Get notified about significant changes and anomalies that require your attention, before they impact your bottom line.",
    },
    {
      title: "Auto-Generated Reports",
      content:
        "Save hours with AI-generated reports that highlight key insights and actionable recommendations.",
    },
  ],
  product2: [
    {
      title: "Real Conversations, Real Leads",
      content:
        "AI agents that talk, listen, and learn. They answer queries, guide users, and surface real intent—not just forms filled.",
    },
    {
      title: "Lead Segmentation Engine",
      content:
        "Automatically categorize and prioritize leads based on behavior, intent, and engagement signals.",
    },
    {
      title: "Instant CRM Sync- CRM integration",
      content:
        "Seamlessly connect with your existing CRM systems for unified data flow and management.",
    },
    {
      title: "First Response in Seconds",
      content:
        "Immediate engagement with prospects when interest is highest, dramatically increasing conversion rates.",
    },
  ],
};
...
const START_SCALING_LINKS: Record<"product1" | "product2", string> = {
  ...
  product2: "https://sniperthink.com/aiagents/",
};
=======
    id: 'product1',
    title: 'Intelligence Growth Engine',
...
>>>>>>> e9e8ed7364915a0e4cd8071feab095e074073631
  ...
  return (
    <div
      id={product.id}
<<<<<<< HEAD
      className={`flex flex-col gap-4 overflow-hidden bg-gradient-to-b ${
        product.gradient
...
<<<<<<< HEAD
      ...
      >
        <span className="text-white text-[9px] lg:text-[10px] font-poppins">
          Our Products
        </span>
=======
          width: 'clamp(80px, 8vw, 97px)',
...
<<<<<<< HEAD
            ...
            opacity: 1,
            background:
              "linear-gradient(0deg, rgba(26, 98, 98, 0.16), rgba(26, 98, 98, 0.16)), linear-gradient(180deg, rgba(26, 98, 98, 0.2) 0%, rgba(189, 239, 244, 0.2) 100%)",
=======
            width: '100%',
            minHeight: '400px',
            height: 'auto',
...
>>>>>>> e9e8ed7364915a0e4cd8071feab095e074073631
          ...
          >
            ...
            >
              <motion.a
<<<<<<< HEAD
                href={START_SCALING_LINKS[activeProduct]}
                target="_blank"
...
export default function ProductsSection() {
  const [activeProduct, setActiveProduct] = useState<"product1" | "product2">(
    "product1"
  );
  ...
  const [mobileActiveProduct, setMobileActiveProduct] = useState<
  ...
  const mobileSwitchProduct = useCallback(
...
<<<<<<< HEAD
        SniperThink offers two powerful growth products. Whether you&apos;re
        looking to unify your business data or automate and segment customer
        interactions, our tools are designed to replace chaos with clarity and
=======
...
<<<<<<< HEAD
          ...
          >
            <div
              className="flex flex-col-reverse md:flex-row gap-6 p-4 sm:p-6 md:p-8 shadow-lg relative backdrop-blur-[30px] overflow-hidden"
              style={{
                width: "100%",
