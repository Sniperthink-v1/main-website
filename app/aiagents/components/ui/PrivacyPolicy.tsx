...
export function PrivacyPolicy() {
  return (
    <div className="text-sm text-gray-300 space-y-4">
      ...
      <p>
        Any reference in the form of "we", "us" and "our" would hereinafter refer to the Company. 
        Any person who accesses or uses the Platform/Website shall be termed as the "User", 
        any reference to "You", "Their", "Them" shall hereinafter refer to the User.
      </p>
      
      <p>
        Your access and/or usage of the Platform/Website indicates that you have read, 
        understood and agreed in full to this Privacy Policy.
      </p>
      
      <p>
        In the pursuance of our legal commitments, we have drafted and displayed this Privacy Policy 
        and You agree that any information You share with us, is only after voluntarily consenting to this Privacy Policy.
      </p>
      ...
      <h3 className="text-md font-semibold mt-6 mb-2">What Personal Information May Be Collected</h3>
      
      <p>
        In the course of providing services, the Company may have to collect certain Personal Information from you. 
        This information would, inter alia, include the following:
      </p>
      ...
      <p>
        You agree and voluntarily consent to provide correct and accurate information. We shall not be liable for any 
        inaccuracies in the information provided by You or any direct or indirect consequences of such inaccurate information. 
        If we find out, either on our own or through any other means that You have provided false information, 
        we shall be at liberty to restrict your access to the Platform/Website and our services.
      </p>
      ...
      <ol className="list-decimal pl-6 space-y-4">
        ...
        <li>
          ...
          <p className="mt-1">
            ...
            We use Cookies to provide you with a more personalized experience on the Platform/Website. You can change Your 
            browser settings and choose to disable sharing of information through cookies. Sometimes, tracking pixels 
            including but not limited to browser HTML pixels may be used to collect information about user behaviour on the 
        ...
        <li>
          ...
          <p className="mt-1">
            ...
            information about your use of its service to the Company. This information could include, but is not limited to, the user 
            ID associated with your account (for example, your Twitter/Instagram User ID), an access token necessary to access that 
            service, any information that you have permitted the third party to share with us, and any information you have made 
      ...
      <p>
        You agree that the aforementioned purposes are valid and give Your informed consent to the collection of Your 
        Personal Information for such purposes.
      </p>

      <h3 className="text-md font-semibold mt-6 mb-2">How long will the Personal Information collected be retained by the Company?</h3>
      
      <p>
        Subject to applicable laws, any information that is provided by you may be retained by the Company, 
        at its sole discretion for as long as required for commercial purposes of the Company.
      </p>

      <h3 className="text-md font-semibold mt-6 mb-2">Whom does the Company share Your Personal Information with?</h3>
      ...
      <p>
        ...
        You agree that You shall not hold the Company liable if Your Personal Information is unauthorizedly disclosed or misused 
      ...
      <p>
        ...
        of the aforementioned rights, kindly inform us within a time period of 15 days after you provide the information to Us, 
        failing which, We may not be able to entertain such requests.
      </p>

      <h3 className="text-md font-semibold mt-6 mb-2">How do we protect your information?</h3>
      ...
      <p>
        ...
        internet is susceptible to unforeseen security issues, we can only make reasonable efforts to protect Your Personal Information, 
        but cannot give an absolute guarantee regarding the same. We shall not be liable in the event, Your Personal Information is 
        unauthorizedly disclosed on account of improper use or disclosure, unauthorized modification and unlawful destruction or accidental 
      ...
      <p>
        Some content on the Platform/Website may contain links to third-party websites or Platform/Websites. If You choose to click 
        on such links, You would be re-directed to a third-party website. Please note that, Our terms of use and privacy policy cease 
        to apply as and when You are redirected to a third party website. You are advised to read the privacy policy of such third-party 
        website before You submit any Personal Information on such a website. We shall not be responsible for any loss of information 
        which may occur on such third-party websites. We are not liable to obtain your consent for third-party's privacy policy.
      </p>

      <h3 className="text-md font-semibold mt-6 mb-2">Changes to Privacy Policy</h3>
      
      <p>
        There may be changes to this Privacy Policy from time to time. The last effective date shall be highlighted at the top of policy 
        information. You shall be solely liable to review the Privacy Policy for any changes. The Company is not obliged to intimate You 
      ...
      <p>
        You agree that You shall not hold the Company responsible or liable for any non-performance of any obligations under this 
      ...
      <p>
        You further agree, that You shall not hold the Company liable for any unauthorised disclosure or leakage of your Personal 
        Information, directly or indirectly, by the Company or any third-party. The Company shall not be liable for any indirect, 
        consequential or remote damages arising out of or in connection with this privacy policy. The total liability of the Company 
        in the event of breach of this privacy policy shall not exceed INR 1000.
      </p>

      <h3 className="text-md font-semibold mt-6 mb-2">Governing Law and Jurisdiction</h3>
