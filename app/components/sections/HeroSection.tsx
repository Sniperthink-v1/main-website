  ...
  return (
    <div
      ...
      className="relative w-full overflow-hidden 
                 ...
                 lg:pt-[160px] lg:pb-[80px] lg:px-[80px]"
    >
      <div className="absolute top-[-250px] left-[-70px] w-[350px] h-[350px] rotate-0 opacity-100 bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[200px] pointer-events-none z-10 sm:top-0 hidden sm:flex z-10"></div>
      <div className="absolute top-[-20px] left-[120px] w-[180px] h-[180px] sm:top-[-150px] sm:left-[700px] sm:w-[450px] sm:h-[450px] rotate-0 opacity-100 bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[120px] sm:blur-[250px] pointer-events-none z-10 flex"></div>
      <div className="absolute bottom-[250px] right-[20px] w-[180px] h-[180px] blur-[150px] sm:bottom-[250px] sm:right-[10px] sm:w-[350px] sm:h-[350px] sm:blur-[200px] rotate-0 opacity-100 bg-gradient-to-t from-[#1A6262] to-[#1A6262] pointer-events-none z-10 sm:flex hidden"></div>
      ...
      <div className="relative z-20 flex flex-col items-center justify-center gap-[48px] w-full">
        ...
        >
          <div className="relative w-fit font-inter font-medium text-white text-sm md:text-base text-center leading-tight md:leading-[20px] whitespace-nowrap">
