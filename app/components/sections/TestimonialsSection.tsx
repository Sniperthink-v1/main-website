...
>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 w-full mb-6 md:mb-8 lg:mb-12">
        ...
        <div className="absolute top-20 left-0 w-[150px] h-[150px] sm:top-32 sm:w-[220px] sm:h-[220px] md:top-40 md:w-[300px] md:h-[300px] bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[100px] sm:blur-[120px] md:blur-[150px] opacity-100 pointer-events-none z-10"></div>
        <div className="absolute bottom-10 right-5 w-[150px] h-[150px] sm:bottom-auto sm:top-[-10px] sm:right-40 sm:w-[220px] sm:h-[220px] md:right-80 md:w-[300px] md:h-[300px] bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[100px] sm:blur-[120px] md:blur-[150px] opacity-100 pointer-events-none z-10"></div>
      </div>
