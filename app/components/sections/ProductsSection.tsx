...
const IMAGES: Record<'product1' | 'product2', string> = {
  product1: '/img/products-brief-image.png',
...
const MobileProductCard = ({ 
  ...
  return (
    ...
    >
      ...
      >
        <Image
          className="w-20 h-auto opacity-80 z-50"
          src={product.img}
          alt={`${product.title} pattern`}
          width={400}
          height={400}
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <motion.a
                href="https://calendly.com/admin-sniperthink/walk-through-for-demos?month=2025-09" target="_blank" rel="noopener noreferrer"
...
export default function ProductsSection() {
  ...
  return (
    ...
    >
      {/* Decorative gradient */}
      <div className="absolute top-[0] right-[950px] w-[300px] h-[300px] rotate-0 opacity-100 bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[200px] pointer-events-none z-10 hidden sm:flex"></div>
            ...
            <div className="flex flex-col-reverse md:flex-row gap-6 p-4 sm:p-6 md:p-8 shadow-lg relative backdrop-blur-[30px] overflow-hidden"
              ...
              <div className="flex flex-col flex-1 min-h-[400px] lg:h-[600px] overflow-y-auto pt-[40px] lg:pt-[60px] scrollbar-hide">
                {currentFeatures.map((feature, index) => (
                  ...
                  <a
                    href="https://calendly.com/admin-sniperthink/walk-through-for-demos?month=2025-09" target="_blank" rel="noopener noreferrer"
                    className="inline-block transition-all hover:opacity-90 mt-4 pt-6 lg:pt-9 pl-[-50px]"
                  >
                    <Image
                      src="/img/start-scaling.png"
                      alt="START SCALING"
