  ...
  "
    >
      ...
      <div className="flex-1 flex justify-center lg:justify-end items-center mt-8 lg:mt-0 z-10">
       ...
       <div className="absolute top-[-60px] left-1/2 -translate-x-1/2 w-[120px] h-[120px] sm:w-[180px] sm:h-[180px] md:w-[250px] md:h-[250px] md:top-[-150px] md:left-[70%] md:translate-x-0 bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[80px] sm:blur-[120px] md:blur-[150px] opacity-100 pointer-events-none z-10"></div>

       <div className="absolute bottom-[-100px] left-[20px] w-[120px] h-[120px] sm:top-[-30px] sm:bottom-auto sm:w-[160px] sm:h-[160px] md:w-[200px] md:h-[200px] bg-gradient-to-t from-[#1A6262] to-[#1A6262] blur-[80px] sm:blur-[100px] md:blur-[120px] opacity-100 pointer-events-none z-10"></div>
