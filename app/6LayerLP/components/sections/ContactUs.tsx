    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="relative bg-black bg-opacity-50 z-50 !flex !items-center backdrop-blur-sm"
          onClick={onClose}
        >
          <motion.div
            ref={modalRef}
            ...
            className={`relative bg-black/90 border flex justify-center items-center border-white/20 rounded-2xl sm:rounded-3xl shadow-2xl p-6 sm:p-8 max-w-lg w-full m-4`}
