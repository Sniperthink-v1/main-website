...
export default function WhyChooseSection() {
  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden w-full mb-8 flex justify-center items-center">
        <Image
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="hidden lg:block absolute top-[250px] right-1 pt-20"
      >
        <Image
      ...
      <div className="flex-1 flex flex-col items-start text-left gap-6 sm:gap-8 lg:gap-10 relative max-w-full lg:max-w-[600px] z-10">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[40px] font-poppins font-semibold text-white leading-snug tracking-[-1px] lg:tracking-[-2px]"
        >
          Why Choose
          <br />
          SniperThink?
        ...
        <div className="flex flex-col gap-6 sm:gap-8 w-full">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="flex justify-center lg:justify-start items-start w-full"
          >
