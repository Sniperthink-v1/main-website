      ...
      <div className="relative z-10 w-full">
        ...
        <div className="block lg:hidden">
          ...
          <motion.div 
            ...
            className="flex flex-col gap-5 p-8 sm:p-12 w-full mx-0 sm:mx-6 mb-8 rounded-[30px] sm:rounded-[60px] overflow-hidden backdrop-blur-[15px] bg-gradient-to-b from-[rgba(26,98,98,0.2)] to-[rgba(189,238,244,0.2)]"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
            className="flex justify-start items-start w-full mb-6"
          >
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
            className="flex flex-col gap-4 sm:gap-[18px] w-full"
          >
            {faqs.map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="hidden lg:flex items-start gap-6 lg:gap-[60px] xl:gap-[80px] pt-10 lg:pt-20 w-full ">
          ...
          <motion.div 
            ...
            viewport={{ once: true, amount: 0.3 }}
            className="flex-1 basis-0 w-full min-w-0"
          >
