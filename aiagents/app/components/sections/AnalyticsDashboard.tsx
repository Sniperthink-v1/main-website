...
import { Card, CardContent } from "@aiagents/app/components/ui/card"
import { Badge } from "@aiagents/app/components/ui/badge"
import { Activity, BarChart3, Calendar, HelpCircle, ArrowUp, ChevronRight, ChevronLeft } from "lucide-react";
import { FileText } from "lucide-react";
import { useState, useEffect } from "react";
import { Popover, PopoverContent, PopoverTrigger } from "@aiagents/app/components/ui/popover";
import { format } from "date-fns";
import { cn } from "@aiagents/lib/utils";
import { DayPicker, NavProps} from "react-day-picker";
import { Calendar as CalendarComponent } from "@aiagents/app/components/ui/calendar";
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 pointer-events-none hidden md:block">
            ...
            <div className="absolute top-0 left-0 w-80 h-48 opacity-20 transform -rotate-6 scale-75">
              <img
                src="/aiagents/images/agents-dashboard.png"
            ...
            <div className="absolute top-10 right-0 w-64 h-56 opacity-15 transform rotate-12 scale-75">
              <img
                src="/aiagents/images/find-user.png"
            ...
            <div className="absolute bottom-0 left-10 w-72 h-40 opacity-20 transform rotate-3 scale-75">
              <img
                src="/aiagents/images/call-log.png"
                alt="Call Log"
                className="w-full h-full object-cover rounded-xl border border-white/10"
              />
            </div>
